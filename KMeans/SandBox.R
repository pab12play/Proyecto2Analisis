...
aggregate(PromedioSimple,by=list(clustersPromSimp$cluster),mean)
...
aggregate(PromedioSimple,by=list(clustersPromPond$cluster),mean)
...
aggregate(promedioCursoCFI,by=list(clustersPromCFI$cluster),mean)
...
aggregate(promedioCursoEspecifico,by=list(clustersPromEspecifico$cluster),mean)
...
aggregate(promedioCursoNumerico,by=list(clustersPromNumerico$cluster),mean)
...
aggregate(promedioCursoProfecionales,by=list(clustersPromProfecionales$cluster),mean)
